...
var DraggableModalContext = /*#__PURE__*/React.createContext(null);
...
function DraggableModalInnerNonMemo(_ref) {
  ...
  var onDragWithID = React.useCallback(function (args) {
  ...
  var onResizeWithID = React.useCallback(function (args) {
    return dispatch(_extends({
      type: 'resize',
      id: id
    }, args));
  ...
  return React.createElement(antd.Modal, Object.assign({
    ...
    title: titleElement,
    open: open
  }, otherProps), children, React.createElement(ResizeHandle, {
    onMouseDown: onMouseResize
  }));
}

var DraggableModalInner = /*#__PURE__*/React.memo(DraggableModalInnerNonMemo);
...
var DraggableModal = function DraggableModal(props) {
  ...
  var id = reactUid.useUID(); // Get modal provider.
  ...
  return React.createElement(DraggableModalInner, Object.assign({
    id: id,
    dispatch: dispatch,
...
var DraggableModalProvider = function DraggableModalProvider(_ref) {
  ...
  var _useReducer = React.useReducer(draggableModalReducer, initialModalsState),
      state = _useReducer[0],
...
//# sourceMappingURL=ant-design-draggable-modal.cjs.development.js.map
